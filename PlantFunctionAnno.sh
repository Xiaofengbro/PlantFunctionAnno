...
sed -i 's/*//g' $pep
## NR
diamond blastp -d /md3400/sunxiaofeng/assembly/00.databases/ncbi/NR_Magnoliopsida.dmnd -q $pep --sensitive --evalue 1e-10 --out nr.blast.out
python -m jcvi.formats.blast best -n 1 nr.blast.out
awk -F'\t' 'NR==FNR{a[$1]=$2;next}{if($2 in a) print $1"\t"a[$2]}' /md3400/sunxiaofeng/assembly/00.databases/ncbi/NR_Magnoliopsida_id2anno.tsv nr.blast.out.best | sed '1i\gene\tNR' > NR.anno
rm nr.blast.out.best
## uniprot_sport_plant
diamond blastp -d /md3400/sunxiaofeng/assembly/00.databases/uniprot/uniprot_sprot_plants.dmnd -q $pep --ultra-sensitive --evalue 1e-10 --out Swissprot.blast.out
...
python ~/script/anno_dir/uniprot2anno.py -i id2usp.tsv -a /md3400/sunxiaofeng/assembly/00.databases/uniprot/uniprot_sprot_plants.tsv -o Swissprot.anno
rm Swissprot.blast.out.best id2usp.tsv
## uniprot_trembl_plants
diamond blastp -d /md3400/sunxiaofeng/assembly/00.databases/uniprot/uniprot_trembl_plants.dmnd -q $pep --sensitive --evalue 1e-10 --out TrEMBL.blast.out
...
python ~/script/anno_dir/uniprot2anno.py -i id2upt.tsv -a /md3400/sunxiaofeng/assembly/00.databases/uniprot/uniprot_trembl_plants.tsv -o TrEMBL.anno
rm TrEMBL.blast.out.best id2upt.tsv
## KEGG & Pathway
nohup exec_annotation --cpu 128 -f detail-tsv -p /md3400/sunxiaofeng/assembly/00.databases/kofam/profiles/ -k /md3400/sunxiaofeng/assembly/00.databases/kofam/ko_list -E 1e-5 -o kegg.txt --tmp-dir ./kegg_tem $pep &
...
## eggNOG
pyhmmsearch -i $pep -b /md3400/sunxiaofeng/assembly/00.databases/emapper/Streptophyta.pkl.gz -o eggnog.hmm.out -p 128 -e 1e-10
reformat_pyhmmsearch -b -i eggnog.hmm.out -o eggnog.hmm.out.best
awk -F'\t' 'NR==FNR{a[$1]=$2;next} FNR==1{next} {if($2 in a) print $1"\t"a[$2]}' /md3400/sunxiaofeng/assembly/00.databases/emapper/og2anno.tsv eggnog.hmm.out.best | sed '1i\gene\teggNOG' > eggNOG.anno
#diamond blastp -d /md3400/sunxiaofeng/assembly/00.databases/emapper/Streptophyta.dmnd -q $pep --sensitive --evalue 1e-10 --out eggnog.blast.out
#python -m jcvi.formats.blast best -n 1 eggnog.blast.out
#awk -F'\t' 'NR==FNR{a[$1]=$2;next}{if($2 in a) print $1"\t"a[$2]}' /md3400/sunxiaofeng/assembly/00.databases/emapper/id2anno.tsv eggnog.blast.out.best | sed '1i\gene\teggNOG' > eggNOG.anno
...
# GO
python ~/script/anno_dir/interpro2GO.py -i interproscan -a /home/sunxiaofeng/script/anno_dir/Richer_anno/GOid2altid.txt -d /home/sunxiaofeng/script/anno_dir/Richer_anno/GO_descript.txt -o GO.anno -g gene.GOrich.bg
# interpro_accession
